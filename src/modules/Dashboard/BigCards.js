...
function BigCards() {
  return (
    <div className="__big_cards flex flex-col md:flex-row gap-[24px]">
      <Panel
        className="__first_card mb-[10px] md:mb-0 w-full lg:w-[80%] __item_big bg-white p-[20px] rounded-[15px]"
        shadow={true}
      >
        <div className="flex xl:flex-row flex-col justify-between">
          <div className="__left_content flex flex-col items-start justify-between lg:order-1 order-2">
            <div className="">
          ...
          <div className="__right_content flex flex-auto justify-center items-center lg:order-2 md:order-1 mb-[10px] lg:mb-0 bg-[#4FD1C5] rounded-[12px]"></div>
        </div>
      </Panel>

      <Panel
        className="__second_card rounded-[15px] p-[15px] bg-white flex items-center"
        shadow={true}
      >
        <div className="__bg  h-[300px] md:h-[95%] flex flex-col justify-between text-white p-[20px] mb-[6px]">
          <div>
